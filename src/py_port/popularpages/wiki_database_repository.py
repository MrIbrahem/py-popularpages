...
class WikiDatabaseRepository:
    ...
    def _get_projects_timestamps(self, titles: list[str]) -> list[dict[str, Any]]:
        ...
        :param titles: Display-form (space) page titles whose last bot edit
            timestamp should be fetched.
        :return: List of dicts with 'page_title' (display form, no underscores),
            'rev_timestamp', and 'name'.
        """
